Contributing to BTCU Core
============================

The BTCU Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bitcoin-ultimatum/btcu/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BTCU Core project, and is not to be
confused with overall BTCU Network Protocol consensus changes.

Whether a pull request is merged into BTCU Core rests with the project merge
...
Patches that change BTCU consensus rules are considerably more involved than
...
Where a patchset proposes to change the BTCU consensus, it must have been
...
The project leader is the release manager for each BTCU Core release.
